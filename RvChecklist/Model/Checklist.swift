...
struct SeedData {
    static var contents: [ChecklistItem] = [
        ...
        ChecklistItem(id: "moveBox",
                      name: "Move Box",
                      category: "Departure",
                      order: 2037,
                      description: "Raise desk. Remove storage boxes from within the large outside box, then move box into office under desk. Then put storages boxes back into box and close lid."),
        ...
        ChecklistItem(id: "moveBoxOut",
                      name: "Move Box Out of Office",
                      category: "Arrival",
                      order: 2063,
                      description: "Raise desk. Remove storage boxes from within the large box, then move box to outside. Then put storages boxes back into box and close lid."),
